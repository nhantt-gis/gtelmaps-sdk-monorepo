...
import {createRenderBackend} from '../render/backend_registry';
import {type RenderBackend} from '../render/render_backend';
...
export class Map extends Camera {
    ...
    */
    ...
    setTerrain(options: TerrainSpecification | null): this {
        ...
        if (!options) {
            ...
            this.painter.setTerrain(this.terrain);
    ...
    * to unset glyphs.
    ...
    _setupPainter() {
        ...
        this.painter = createRenderBackend(gl, this.transform);
    }
